...
{
    [SimVar("AILERON POSITION", "Position 16k", 1)]
    public double AilPos;

    [SimVar("ELEVATOR POSITION", "Position 16k", 2)]
    ...
    public struct Flaps
    {
        [SimVar("FLAPS HANDLE INDEX:0", "Number", 1)]
        public int Flaps0;

        [SimVar("FLAPS HANDLE INDEX:1", "Number", 2)]
        public int Flaps1;

        [SimVar("FLAPS HANDLE INDEX:2", "Number", 3)]
        public int Flaps2;

        [SimVar("FLAPS HANDLE INDEX:3", "Number", 4)]
        public int Flaps3;

        [SimVar("FLAPS HANDLE INDEX:4", "Number", 5)]
        public int Flaps4;

        [SimVar("FLAPS HANDLE INDEX:5", "Number", 6)]
        public int Flaps5;

        [SimVar("FLAPS HANDLE INDEX:6", "Number", 7)]
        public int Flaps6;

        [SimVar("FLAPS HANDLE INDEX:7", "Number", 8)]
        public int Flaps7;

        [SimVar("FLAPS HANDLE INDEX:8", "Number", 9)]
        public int Flaps8;

        [SimVar("FLAPS HANDLE INDEX:9", "Number", 10)]
        public int Flaps9;

        [SimVar("FLAPS HANDLE INDEX:10", "Number", 11)]
        public int Flaps10;

        [SimVar("FLAPS HANDLE INDEX:11", "Number", 12)]
        public int Flaps11;

        [SimVar("FLAPS HANDLE INDEX:12", "Number", 13)]
        public int Flaps12;

        [SimVar("FLAPS HANDLE INDEX:13", "Number", 14)]
        public int Flaps13;

        [SimVar("FLAPS HANDLE INDEX:14", "Number", 15)]
        public int Flaps14;

        [SimVar("FLAPS HANDLE INDEX:15", "Number", 16)]
        public int Flaps15;
        ...
        public class Codec : IPacketCodec<Flaps>
        {
            ...
            public Flaps Decode(BinaryReader br)
            {
                var flaps = new Flaps
                {
                    Flaps0 = br.ReadInt32(),
