...
public struct Fuel
{
    [SimVar("FUEL TANK LEFT MAIN LEVEL", "Percent Over 100", 1)]
    public double LeftMain;

    [SimVar("FUEL TANK RIGHT MAIN LEVEL", "Percent Over 100", 2)]
    public double RightMain;

    [SimVar("FUEL TANK LEFT AUX LEVEL", "Percent Over 100", 3)]
    public double LeftAux;

    [SimVar("FUEL TANK RIGHT AUX LEVEL", "Percent Over 100", 4)]
    ...
    public class Codec : IPacketCodec<Fuel>
    {
        ...
        public Fuel Decode(BinaryReader br)
        {
            var aircraft = new Fuel
            {
